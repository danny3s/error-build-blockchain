    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', () => {
            ...
            beforeEach(() => {
                ...
                blockchain.addBlock({data: 'beeets'});
            ...
            describe('and the chain contains a block with an invalidad field', () => {
                it('returns false', () => {
            ...
            describe('and the chain does not contain any invalidad blocks', () => {
                it('returns true', () => {
